...
const Home = () => {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-[#0d1117] dark:to-[#161b22] text-gray-900 dark:text-gray-100 relative overflow-x-hidden">
      {/* faint background */}
      <img
      ...
      {/* map section */}
      <main className="relative z-10 flex-1 flex justify-center items-center w-full py-12 px-4">
        <motion.div
          animate={controls}
          className="
            w-full max-w-7xl
